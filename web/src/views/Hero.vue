<template>
  <div class="page-hero" v-if="model">
    <div class="topbar bg-black py-2 px-3 text-white d-flex ai-center" style="align-items:center">
            ...
            <div class="p-3 bg-white border-bottom">
              ...
              <div class="skills bg-white mt-4">
                ...
                <div v-if="currentSkill">
                  <div class="d-flex pt-4 pb-1 ai-center">
  ...
  .info {
    ...
    .scores {
      .badge {
        ...
        font-size: 0.6rem;
        /* line-height: 0.9rem; */
        border: 1p solid rgba(255, 255, 255, 0.2);
      }
    }
  }
  .skills {
